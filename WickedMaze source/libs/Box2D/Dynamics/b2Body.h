...
public:
    ...
    //ALBITH adds a Box2d method!! 5.30.2012
    void ApplyLinearImpulseNoRotate(const b2Vec2& impulse, const b2Vec2& point);
...
//Albith's addition 5.30.2012

inline void b2Body::ApplyLinearImpulseNoRotate(const b2Vec2& impulse, const b2Vec2& point)
{
